# Generated by Powerlevel10k configuration wizard on 2025-08-22 at 13:20 CEST.
...
_my_jj_async() {
  ...
  revision=$(jj log --repository "$workspace" --ignore-working-copy  --no-graph --limit 1 --color always  --revisions @ -T 'prompt')
